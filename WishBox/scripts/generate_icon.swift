#!/usr/bin/env swift
/// Renders the WishlyAI app icon to a 1024×1024 PNG and writes it into the asset catalog.
...
// ── Export ─────────────────────────────────────────────────────────────────
let outPath = "WishBox/WishlyAI/Assets.xcassets/AppIcon.appiconset/AppIcon-1024.png"
